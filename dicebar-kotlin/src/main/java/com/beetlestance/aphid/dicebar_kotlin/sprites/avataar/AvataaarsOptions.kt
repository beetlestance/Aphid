...
@StringDef(
    AvataaarTop.EYE_PATCH, AvataaarTop.LONG_HAIR, AvataaarTop.HAT, AvataaarTop.HIJAB,
    AvataaarTop.SHORT_HAIR, AvataaarTop.TURBAN
)
@Retention(AnnotationRetention.SOURCE)
...
@StringDef(
    AvataaarHat.BLACK, AvataaarHat.BLUE, AvataaarHat.GRAY, AvataaarHat.HEATHER,
    AvataaarHat.PASTEL, AvataaarHat.PINK, AvataaarHat.RED, AvataaarHat.WHITE
)
@Retention(AnnotationRetention.SOURCE)
...
@StringDef(
    AvataaarAccessories.KURT, AvataaarAccessories.PRESCRIPTION_01,
    AvataaarAccessories.PRESCRIPTION_02, AvataaarAccessories.ROUND,
    AvataaarAccessories.SUNGLASSES, AvataaarAccessories.WAYFARERS
)
@Retention(AnnotationRetention.SOURCE)
...
@StringDef(
    AvataaarAccessoriesColor.BLACK, AvataaarAccessoriesColor.BLUE, AvataaarAccessoriesColor.GRAY,
    AvataaarAccessoriesColor.HEATHER, AvataaarAccessoriesColor.PASTEL,
    AvataaarAccessoriesColor.PINK, AvataaarAccessoriesColor.RED, AvataaarAccessoriesColor.WHITE
)
@Retention(AnnotationRetention.SOURCE)
...
@StringDef(
    AvataaarFacialHair.LIGHT, AvataaarFacialHair.FANCY, AvataaarFacialHair.MAJESTIC,
    AvataaarFacialHair.MAGNUM, AvataaarFacialHair.MEDIUM
)
@Retention(AnnotationRetention.SOURCE)
...
@StringDef(
    AvataaarClothes.BLAZER, AvataaarClothes.HOODIE, AvataaarClothes.OVERALL,
    AvataaarClothes.SWEATER, AvataaarClothes.SHIRT
)
@Retention(AnnotationRetention.SOURCE)
...
@StringDef(
    AvataaarClothesColor.BLACK, AvataaarClothesColor.BLUE, AvataaarClothesColor.GRAY,
    AvataaarClothesColor.HEATHER, AvataaarClothesColor.PASTEL, AvataaarClothesColor.PINK,
    AvataaarClothesColor.RED, AvataaarClothesColor.WHITE
)
@Retention(AnnotationRetention.SOURCE)
...
@StringDef(
    AvataaarEyeBrow.ANGRY, AvataaarEyeBrow.DEFAULT, AvataaarEyeBrow.FLAT, AvataaarEyeBrow.FROWN,
    AvataaarEyeBrow.RAISED, AvataaarEyeBrow.SAD, AvataaarEyeBrow.UNIBROW, AvataaarEyeBrow.UP
)
@Retention(AnnotationRetention.SOURCE)
...
@StringDef(
    AvataaarSkin.BLACK, AvataaarSkin.BROWN, AvataaarSkin.DARK_BROWN, AvataaarSkin.LIGHT,
    AvataaarSkin.PALE, AvataaarSkin.TANNED, AvataaarSkin.YELLOW
)
@Retention(AnnotationRetention.SOURCE)
